...
const SinglePage = ({show }) => {
  return (
    <>
      <div className=" bg-dark-100 relative lg:py-20 rounded-lg mt-2 border border-transparent border-gray-300 bg-gray-100 dark:border-neutral-700 dark:bg-neutral-800/30  heropattern-diagonallines-zinc-900">
        <div className="flex flex-col items-center justify-between pt-0 pr-10 pb-0 pl-10 mt-0 mr-auto mb-0 ml-auto max-w-full xl:px-5 lg:flex-row">
          <div className="flex flex-col w-screen p-10 items-center md:flex-col lg:flex-row">
            <div className="flex flex-col justify-center relative lg:pr-10">
              <img src={show.image.original} alt={show.name} width={600} height={600} />
            </div>
            ...
            relative z-10">
                <div className="w-full mt-6 mr-0 mb-0 ml-0 relative space-y-8 text-white">
                  ...
                  <div className="relative">
                    <a href={show.officialSite} className="rounded-md bg-red-600 mb-5 hover:bg-red-800 p-2 pr-8 pl-8 font-bold">
                      Watch Now
                    </a>
